...
import '../../../methods.dart';
import '../../form_for_edit_product_screen/screen/form_for_edit_product_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<AppProvider>(builder: (context, appProvider, child) {
        Product product = appProvider.getOneProduct(widget.id);
        return SafeArea(
          top: true,
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      getDialogWindowForBuyProduct(
                          context, formatNumberWithSpaces(product.price));
                    },
